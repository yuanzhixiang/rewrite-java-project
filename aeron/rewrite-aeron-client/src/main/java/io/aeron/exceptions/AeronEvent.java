...
public class AeronEvent extends AeronException {
    ...
    /**
     * Aeron event with provided message and {@link Category#WARN}.
     *
     * @param message to detail the event.
     */
    public AeronEvent(final String message) {
        super(message, null, false, false, Category.WARN);
    }

    /**
     * Aeron event with provided message and {@link Category}.
     *
     * @param message  to detail the event.
