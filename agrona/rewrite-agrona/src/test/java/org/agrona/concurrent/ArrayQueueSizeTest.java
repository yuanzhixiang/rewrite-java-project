...
class ArrayQueueSizeTest {
    ...
    private final OneToOneConcurrentArrayQueue<Integer> queue = new OneToOneConcurrentArrayQueue<>(QUEUE_CAPACITY);
    ...
    static class Producer implements Runnable {
        private final OneToOneConcurrentArrayQueue<Integer> queue;
        private volatile boolean isRunning = true;

        Producer(final OneToOneConcurrentArrayQueue<Integer> queue) {
            this.queue = queue;
        }
    ...
    static class Consumer implements Runnable {
        ...
        Consumer(final OneToOneConcurrentArrayQueue<Integer> queue) {
            this.queue = queue;
        }
